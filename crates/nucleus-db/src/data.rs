//! Hand-verified alternate-function seed data for the STM32F446RE.
//!
//! A small, manually checked subset covering the peripherals used in the
//! README's example `stm32.toml`, verified against the STM32F446xx datasheet
//! "Alternate function mapping" table (DS10693). Eventually this will be
//! generated by [`crate::pack`] from a CMSIS Device Family Pack.
//!
